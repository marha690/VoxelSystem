...
public:	
	...
	AWorldSlice();
	void initialize(int numChunks, int cSize, int chunkDimension, FVector2D cIndex, UMaterial* material, TArray<FColor>* cPalette = nullptr);
